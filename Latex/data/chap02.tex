...
\begin{figure}[h]
  \centering%
      {\includegraphics[width=0.9\textwidth]{ch2/salcomp1.png}}
...
\begin{figure}[h]
  \centering%
      {\includegraphics[width=0.9\textwidth]{ch2/salcomp2.png}}
...
\begin{figure}[h]
  ...
  \subcaptionbox{F-Measure曲线\label{fig:sub:ecssdFCurve}} %标题的长度，超过则会换行，如下一个小图。
    {\includegraphics[width=0.45\textwidth]{ch2/ECSSD_FCurve}}%
 %\hspace{1em}%
  \subcaptionbox{平均F-Measure\label{fig:sub:ecssdAvg}}
      {\includegraphics[width=0.45\textwidth]{ch2/ECSSD_FBar.png}}
...
\begin{figure}[h]
  ...
  \subcaptionbox{F-Measure曲线\label{fig:sub:asdFCurve}} %标题的长度，超过则会换行，如下一个小图。
    {\includegraphics[width=0.45\textwidth]{ch2/ASD_FCurve}}%
 %\hspace{1em}%
  \subcaptionbox{平均F-Measure\label{fig:sub:asdAvg}}
      {\includegraphics[width=0.45\textwidth]{ch2/ASD_FBar.png}}
